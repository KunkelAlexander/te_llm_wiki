...
departing EEA airports, not just intra-EEA ones — addressing the industry's counterargument that
this would just push passengers to reroute via non-EU hubs (Istanbul, Dubai, Moscow) to dodge ETS
costs ("carbon leakage"). The study finds a genuine leakage risk exists but is narrower than
industry claims — rerouted trips aren't necessarily longer or more emitting — and estimates the
scope extension would cut demand/emissions by 6.6 MtCO2 in 2030 and 7.4 MtCO2 in 2035. For
context, it notes CORSIA (the industry-favoured global alternative) only prices emissions above an
...
argument that aviation taxes and charges are suppressing demand and should be cut. It finds
location costs (taxes, airport and air navigation fees) are a minor share of total airline costs
with little measurable effect on passenger volumes, and that cost/competition factors explain at
most 20% of the gap between German and wider-European post-COVID passenger recovery (citing a 2025
DLR finding) — standard price/cost elasticity models have low explanatory power in this market.
Airlines also only pass through less than 50% of individual cost increases to fares (industry-wide
